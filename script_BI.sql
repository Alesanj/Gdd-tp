...
IF OBJECT_ID('BI_MODEL.HECHO_CUPON', 'U') IS NOT NULL DROP TABLE BI_MODEL.HECHO_ENVIO
...
SELECT DISTINCT RECLAMO_FECHA, RECLAMO_FECHA_SOLUCION FROM NEW_MODEL.RECLAMO WHERE MONTH(RECLAMO.RECLAMO_FECHA) = 2
