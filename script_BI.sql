...
CREATE TABLE BI_MODEL.TIPO_ENVIO(
	TIPO_NRO int IDENTITY PRIMARY KEY,
	TIPO nvarchar(50)
);
...
CREATE VIEW BI_MODEL.PROMEDIO_VALOR_ASEGURADO_X_TIPO_PAQUETE_X_MES AS
	...
	HECHO_MENSAJERIA_MES_NRO AS MES_NRO
	...
	GROUP BY HECHO_MENSAJERIA_MES_NRO, t_paquete.TIPO_PAQUETE_NOMBRE;
...
CREATE VIEW BI_MODEL.VALOR_PROMEDIO_MENSUAL_PEDIDOS_EN_CADA_LOCALIDAD AS
	...
	HECHO_ENVIA_MES_NRO AS MES_NRO,
	t_localidad.LOCALIDAD_NOMBRE AS LOCALIDAD
	FROM BI_MODEL.HECHO_ENVIO h_envio
		JOIN BI_MODEL.LOCALIDAD t_localidad on t_localidad.LOCALIDAD_NRO= h_envio.HECHO_ENVIO_LOCALIDAD
	WHERE HECHO_ENVIO_TIPO_ENVIO = 2
	GROUP BY HECHO_ENVIA_MES_NRO,t_localidad.LOCALIDAD_NOMBRE
GO
...
FROM
    ...
    JOIN BI_MODEL.LOCALIDAD t_localidad ON h_envio.HECHO_ENVIO_LOCALIDAD = t_localidad.LOCALIDAD_NRO
WHERE
...
GO
	...
	--SELECT * FROM BI_MODEL.PORCENTAJE_DE_CADA_TIPO_ENTREGA_SEGUN_EDAD_REPARTIDOR_Y_LOCALIDAD
